...
public class StringUtil extends StringUtils {
	...
	/**
	 * 转驼峰命名-转下划线驼峰 userName -> user_name,UserName -> user_name
	 *
	 * @param field 字段
	 * @return String
	 */
	public static String toCamelUnderline(String field) {
		char[] keyCharArr = StringUtil.firstToLowerCase(field).toCharArray();
		StringBuilder stringBuffer = new StringBuilder();
		for (char keyChar : keyCharArr) {
			if (StringUtil.isUpperCaseLetter(keyChar)) {
	...
	/**
	 * 下划线转大小写驼峰(首字母小写) user_name -> userName,UserName -> userName
	 *
	 * @param field 字段
	 * @return String
	 */
	public static String toCaseCamel(String field) {
		char[] keyCharArr = StringUtil.firstToLowerCase(field).toCharArray();
		StringBuilder stringBuffer = new StringBuilder();
